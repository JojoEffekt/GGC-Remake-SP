...
public class DinnerUIController : MonoBehaviour
{
    ...
    public void LoadItems(){
        ...
        //DinnerItemList.Add(new DinnerItem("Cheese Fondue","Dinner_21_04","type_fruit","background_dinner",0,new Dictionary<string ,string>(){{"number","1560"},{"time","720"},{"moneyPerItem","1"},{"xp","1229"},{"moneyPerItemSI","0"},{"xpSI","0"}},new Dictionary<string ,int>(){{"item_32",},{"item_21",1},{"item_22",1}},new Dictionary<string ,int>(){{"item_30",1}},new Dictionary<string ,int>(){{"bronze_star_icon",0},{"silver_star_icon",0},{"gold_star_icon",0}}));
        //DinnerItemList.Add(new DinnerItem("Baked Potatoes","Dinner_19_04","type_main","background_dinner",0,new Dictionary<string ,string>(){{"number","130"},{"time","60"},{"moneyPerItem","9"},{"xp","165"},{"moneyPerItemSI","0"},{"xpSI","0"}},new Dictionary<string ,int>(){{"item_08",},{"item_13",1},{"item_36",1}},new Dictionary<string ,int>(){{"item_05",1}},new Dictionary<string ,int>(){{"bronze_star_icon",0},{"silver_star_icon",0},{"gold_star_icon",0}}));
        ...
        //DinnerItemList.Add(new DinnerItem("Sushi","Dinner_27_04","type_burger","background_dinner",0,new Dictionary<string ,string>(){{"number","2000"},{"time","960"},{"moneyPerItem","1"},{"xp","1872"},{"moneyPerItemSI","0"},{"xpSI","0"}},new Dictionary<string ,int>(){{"item_06",},{"item_47",1},{"item_25",1}},new Dictionary<string ,int>(){{"item_20",1}},new Dictionary<string ,int>(){{"bronze_star_icon",0},{"silver_star_icon",0},{"gold_star_icon",0}}));
